...
// include: /usr/local/share/dotnet/packs/Microsoft.NETCore.App.Runtime.Mono.browser-wasm/9.0.8/runtimes/browser-wasm/native/src/es6/dotnet.es6.pre.js
...
// end include: /usr/local/share/dotnet/packs/Microsoft.NETCore.App.Runtime.Mono.browser-wasm/9.0.8/runtimes/browser-wasm/native/src/es6/dotnet.es6.pre.js
...
var ASM_CONSTS = {
 ...
 639067: ($0, $1, $2, $3, $4) => { var w = $0; var h = $1; var hot_x = $2; var hot_y = $3; var pixels = $4; var canvas = document.createElement("canvas"); canvas.width = w; canvas.height = h; var ctx = canvas.getContext("2d"); var image = ctx.createImageData(w, h); var data = image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = (val >> 24) & 0xff; src++; dst += 4; } } else { var data32 = new Int32Array(data.buffer); num = data32.length; data32.set(HEAP32.subarray(src, src + num)); } ctx.putImageData(image, 0, 0); var url = hot_x === 0 && hot_y === 0 ? "url(" + canvas.toDataURL() + "), auto" : "url(" + canvas.toDataURL() + ") " + hot_x + " " + hot_y + ", auto"; var urlBuf = _malloc(url.length + 1); stringToUTF8(url, urlBuf, url.length + 1); return urlBuf; },  
 640056: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 640139: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 640208: () => { return window.innerWidth; },  
 640238: () => { return window.innerHeight; },  
 640269: ($0) => { var str = UTF8ToString($0) + '\n\n' + 'Abort/Retry/Ignore/AlwaysIgnore? [ariA] :'; var reply = window.prompt(str, "i"); if (reply === null) { reply = "i"; } return allocate(intArrayFromString(reply), 'i8', ALLOC_NORMAL); },  
 640494: () => { if (typeof(AudioContext) !== 'undefined') { return true; } else if (typeof(webkitAudioContext) !== 'undefined') { return true; } return false; },  
 640641: () => { if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return true; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return true; } return false; },  
 640875: ($0) => { if(typeof(Module['SDL2']) === 'undefined') { Module['SDL2'] = {}; } var SDL2 = Module['SDL2']; if (!$0) { SDL2.audio = {}; } else { SDL2.capture = {}; } if (!SDL2.audioContext) { if (typeof(AudioContext) !== 'undefined') { SDL2.audioContext = new AudioContext(); } else if (typeof(webkitAudioContext) !== 'undefined') { SDL2.audioContext = new webkitAudioContext(); } if (SDL2.audioContext) { autoResumeAudioContext(SDL2.audioContext); } } return SDL2.audioContext === undefined ? -1 : 0; },  
 641368: () => { var SDL2 = Module['SDL2']; return SDL2.audioContext.sampleRate; },  
 641436: ($0, $1, $2, $3) => { var SDL2 = Module['SDL2']; var have_microphone = function(stream) { if (SDL2.capture.silenceTimer !== undefined) { clearTimeout(SDL2.capture.silenceTimer); SDL2.capture.silenceTimer = undefined; } SDL2.capture.mediaStreamNode = SDL2.audioContext.createMediaStreamSource(stream); SDL2.capture.scriptProcessorNode = SDL2.audioContext.createScriptProcessor($1, $0, 1); SDL2.capture.scriptProcessorNode.onaudioprocess = function(audioProcessingEvent) { if ((SDL2 === undefined) || (SDL2.capture === undefined)) { return; } audioProcessingEvent.outputBuffer.getChannelData(0).fill(0.0); SDL2.capture.currentCaptureBuffer = audioProcessingEvent.inputBuffer; dynCall('vi', $2, [$3]); }; SDL2.capture.mediaStreamNode.connect(SDL2.capture.scriptProcessorNode); SDL2.capture.scriptProcessorNode.connect(SDL2.audioContext.destination); SDL2.capture.stream = stream; }; var no_microphone = function(error) { }; SDL2.capture.silenceBuffer = SDL2.audioContext.createBuffer($0, $1, SDL2.audioContext.sampleRate); SDL2.capture.silenceBuffer.getChannelData(0).fill(0.0); var silence_callback = function() { SDL2.capture.currentCaptureBuffer = SDL2.capture.silenceBuffer; dynCall('vi', $2, [$3]); }; SDL2.capture.silenceTimer = setTimeout(silence_callback, ($1 / SDL2.audioContext.sampleRate) * 1000); if ((navigator.mediaDevices !== undefined) && (navigator.mediaDevices.getUserMedia !== undefined)) { navigator.mediaDevices.getUserMedia({ audio: true, video: false }).then(have_microphone).catch(no_microphone); } else if (navigator.webkitGetUserMedia !== undefined) { navigator.webkitGetUserMedia({ audio: true, video: false }, have_microphone, no_microphone); } },  
 643088: ($0, $1, $2, $3) => { var SDL2 = Module['SDL2']; SDL2.audio.scriptProcessorNode = SDL2.audioContext['createScriptProcessor']($1, 0, $0); SDL2.audio.scriptProcessorNode['onaudioprocess'] = function (e) { if ((SDL2 === undefined) || (SDL2.audio === undefined)) { return; } SDL2.audio.currentOutputBuffer = e['outputBuffer']; dynCall('vi', $2, [$3]); }; SDL2.audio.scriptProcessorNode['connect'](SDL2.audioContext['destination']); },  
 643498: ($0, $1) => { var SDL2 = Module['SDL2']; var numChannels = SDL2.capture.currentCaptureBuffer.numberOfChannels; for (var c = 0; c < numChannels; ++c) { var channelData = SDL2.capture.currentCaptureBuffer.getChannelData(c); if (channelData.length != $1) { throw 'Web Audio capture buffer length mismatch! Destination size: ' + channelData.length + ' samples vs expected ' + $1 + ' samples!'; } if (numChannels == 1) { for (var j = 0; j < $1; ++j) { setValue($0 + (j * 4), channelData[j], 'float'); } } else { for (var j = 0; j < $1; ++j) { setValue($0 + (((j * numChannels) + c) * 4), channelData[j], 'float'); } } } },  
 644103: ($0, $1) => { var SDL2 = Module['SDL2']; var numChannels = SDL2.audio.currentOutputBuffer['numberOfChannels']; for (var c = 0; c < numChannels; ++c) { var channelData = SDL2.audio.currentOutputBuffer['getChannelData'](c); if (channelData.length != $1) { throw 'Web Audio output buffer length mismatch! Destination size: ' + channelData.length + ' samples vs expected ' + $1 + ' samples!'; } for (var j = 0; j < $1; ++j) { channelData[j] = HEAPF32[$0 + ((j*numChannels + c) << 2) >> 2]; } } },  
 644583: ($0) => { var SDL2 = Module['SDL2']; if ($0) { if (SDL2.capture.silenceTimer !== undefined) { clearTimeout(SDL2.capture.silenceTimer); } if (SDL2.capture.stream !== undefined) { var tracks = SDL2.capture.stream.getAudioTracks(); for (var i = 0; i < tracks.length; i++) { SDL2.capture.stream.removeTrack(tracks[i]); } SDL2.capture.stream = undefined; } if (SDL2.capture.scriptProcessorNode !== undefined) { SDL2.capture.scriptProcessorNode.onaudioprocess = function(audioProcessingEvent) {}; SDL2.capture.scriptProcessorNode.disconnect(); SDL2.capture.scriptProcessorNode = undefined; } if (SDL2.capture.mediaStreamNode !== undefined) { SDL2.capture.mediaStreamNode.disconnect(); SDL2.capture.mediaStreamNode = undefined; } if (SDL2.capture.silenceBuffer !== undefined) { SDL2.capture.silenceBuffer = undefined } SDL2.capture = undefined; } else { if (SDL2.audio.scriptProcessorNode != undefined) { SDL2.audio.scriptProcessorNode.disconnect(); SDL2.audio.scriptProcessorNode = undefined; } SDL2.audio = undefined; } if ((SDL2.audioContext !== undefined) && (SDL2.audio === undefined) && (SDL2.capture === undefined)) { SDL2.audioContext.close(); SDL2.audioContext = undefined; } }
};
function webAudioInit() { try { var AudioContext = window.AudioContext || window.webkitAudioContext; if (!AudioContext) { console.error("Web Audio API is not supported in this browser"); return 0; } window.MG = window.MG || {}; window.MG.audio = { context: new AudioContext(), masterGain: null, buffers: [], sources: [], convolver: null, nextBufferId: 0, nextSourceId: 0 }; window.MG.audio.masterGain = window.MG.audio.context.createGain(); window.MG.audio.masterGain.connect(window.MG.audio.context.destination); window.MG.audio.convolver = window.MG.audio.context.createConvolver(); if (window.MG.audio.context.state === 'suspended') { window.MG.audio.context.resume(); } console.log("Web Audio API initialized successfully"); return 1; } catch (e) { console.error("Failed to initialize Web Audio API:", e); return 0; } }
function webAudioCreateBuffer(data,size,channels,sampleRate,bitsPerSample) { try { var audio = window.MG.audio; if (!audio || !audio.context) return -1; var arrayBuffer = new ArrayBuffer(size); var view = new Uint8Array(arrayBuffer); var srcView = new Uint8Array(HEAPU8.buffer, data, size); view.set(srcView); var bytesPerSample = bitsPerSample / 8; var samplesPerChannel = size / (channels * bytesPerSample); var audioBuffer = audio.context.createBuffer(channels, samplesPerChannel, sampleRate); for (var channel = 0; channel < channels; channel++) { var channelData = audioBuffer.getChannelData(channel); for (var i = 0; i < samplesPerChannel; i++) { var sampleIndex = (i * channels + channel) * bytesPerSample; var sample = 0; if (bitsPerSample === 8) { sample = (view[sampleIndex] - 128) / 128.0; } else if (bitsPerSample === 16) { var value = view[sampleIndex] | (view[sampleIndex + 1] << 8); if (value >= 0x8000) value -= 0x10000; sample = value / 32768.0; } else if (bitsPerSample === 24) { var value = view[sampleIndex] | (view[sampleIndex + 1] << 8) | (view[sampleIndex + 2] << 16); if (value >= 0x800000) value -= 0x1000000; sample = value / 8388608.0; } else if (bitsPerSample === 32) { var value = view[sampleIndex] | (view[sampleIndex + 1] << 8) | (view[sampleIndex + 2] << 16) | (view[sampleIndex + 3] << 24); sample = new Float32Array(new Uint32Array([value]).buffer)[0]; } channelData[i] = sample; } } var bufferId = audio.nextBufferId++; audio.buffers[bufferId] = { buffer: audioBuffer, sampleRate: sampleRate, channels: channels, duration: audioBuffer.duration }; return bufferId; } catch (e) { console.error("Failed to create audio buffer:", e); return -1; } }
function webAudioCreateSource(bufferId,volume,pitch,pan,looped) { try { var audio = window.MG.audio; if (!audio || !audio.context) return -1; var bufferInfo = audio.buffers[bufferId]; if (!bufferInfo) { console.error("Buffer not found:", bufferId); return -1; } var source = audio.context.createBufferSource(); source.buffer = bufferInfo.buffer; source.loop = looped ? true : false; source.playbackRate.value = pitch; var gainNode = audio.context.createGain(); gainNode.gain.value = volume; var pannerNode = null; if (pan !== 0) { if (audio.context.createStereoPanner) { pannerNode = audio.context.createStereoPanner(); pannerNode.pan.value = pan; } else { pannerNode = audio.context.createPanner(); pannerNode.panningModel = 'equalpower'; pannerNode.setPosition(pan, 0, 1 - Math.abs(pan)); } } source.connect(gainNode); if (pannerNode) { gainNode.connect(pannerNode); pannerNode.connect(audio.masterGain); } else { gainNode.connect(audio.masterGain); } source.start(0); var sourceId = audio.nextSourceId++; audio.sources[sourceId] = { source: source, gain: gainNode, panner: pannerNode, bufferId: bufferId, startTime: audio.context.currentTime, volume: volume, pitch: pitch, pan: pan, looped: looped ? true : false, is3D: false }; source.onended = function() { if (!looped) { if (audio.sources[sourceId]) { audio.sources[sourceId].ended = true; } } }; return sourceId; } catch (e) { console.error("Failed to create audio source:", e); return -1; } }
function webAudioStopSource(sourceId,immediate) { try { var audio = window.MG.audio; if (!audio || !audio.sources[sourceId]) return; var sourceInfo = audio.sources[sourceId]; if (sourceInfo.source) { try { sourceInfo.source.stop(0); } catch (e) { } if (immediate) { delete audio.sources[sourceId]; } else { sourceInfo.ended = true; } } } catch (e) { console.error("Failed to stop audio source:", e); } }
function webAudioPauseSource(sourceId) { try { var audio = window.MG.audio; if (!audio || !audio.sources[sourceId]) return 0; var sourceInfo = audio.sources[sourceId]; if (sourceInfo.source && !sourceInfo.paused) { try { var elapsedTime = audio.context.currentTime - sourceInfo.startTime; var position = elapsedTime % sourceInfo.source.buffer.duration; sourceInfo.source.stop(0); sourceInfo.paused = true; sourceInfo.pausePosition = position; return position; } catch (e) { console.error("Error pausing source:", e); } } return 0; } catch (e) { console.error("Failed to pause audio source:", e); return 0; } }
function webAudioResumeSource(sourceId,position) { try { var audio = window.MG.audio; if (!audio || !audio.sources[sourceId]) return -1; var sourceInfo = audio.sources[sourceId]; if (sourceInfo.paused) { var newSource = audio.context.createBufferSource(); newSource.buffer = sourceInfo.source.buffer; newSource.loop = sourceInfo.looped; newSource.playbackRate.value = sourceInfo.pitch; newSource.connect(sourceInfo.gain); newSource.start(0, position); sourceInfo.source = newSource; sourceInfo.startTime = audio.context.currentTime - position; sourceInfo.paused = false; newSource.onended = function() { if (!sourceInfo.looped) { sourceInfo.ended = true; } }; return 1; } return 0; } catch (e) { console.error("Failed to resume audio source:", e); return -1; } }
function webAudioGetSourceState(sourceId) { try { var audio = window.MG.audio; if (!audio || !audio.sources[sourceId]) return 2; var sourceInfo = audio.sources[sourceId]; if (sourceInfo.ended) return 2; if (sourceInfo.paused) return 1; return 0; } catch (e) { console.error("Failed to get audio source state:", e); return 2; } }
function webAudioSetSourceVolume(sourceId,volume) { try { var audio = window.MG.audio; if (!audio || !audio.sources[sourceId]) return; var sourceInfo = audio.sources[sourceId]; if (sourceInfo.gain) { sourceInfo.gain.gain.value = volume; sourceInfo.volume = volume; } } catch (e) { console.error("Failed to set audio source volume:", e); } }
function webAudioSetSourcePitch(sourceId,pitch) { try { var audio = window.MG.audio; if (!audio || !audio.sources[sourceId]) return; var sourceInfo = audio.sources[sourceId]; if (sourceInfo.source && sourceInfo.source.playbackRate) { sourceInfo.source.playbackRate.value = pitch; sourceInfo.pitch = pitch; } } catch (e) { console.error("Failed to set audio source pitch:", e); } }
function webAudioSetSourcePan(sourceId,pan) { try { var audio = window.MG.audio; if (!audio || !audio.sources[sourceId]) return; var sourceInfo = audio.sources[sourceId]; if (sourceInfo.panner) { sourceInfo.gain.disconnect(); sourceInfo.gain.connect(sourceInfo.panner); sourceInfo.panner.disconnect(); sourceInfo.panner = null; } if (pan !== 0) { var pannerNode; if (audio.context.createStereoPanner) { pannerNode = audio.context.createStereoPanner(); pannerNode.pan.value = pan; } else { pannerNode = audio.context.createPanner(); pannerNode.panningModel = 'equalpower'; pannerNode.setPosition(pan, 0, 1 - Math.abs(pan)); } sourceInfo.gain.disconnect(); sourceInfo.gain.connect(pannerNode); pannerNode.connect(audio.masterGain); sourceInfo.panner = pannerNode; } else { sourceInfo.gain.connect(audio.masterGain); } sourceInfo.pan = pan; } catch (e) { console.error("Failed to set audio source pan:", e); } }
function webAudioSetSource3D(sourceId,posX,posY,posZ,forwardX,forwardY,forwardZ,upX,upY,upZ,listenerPosX,listenerPosY,listenerPosZ,listenerForwardX,listenerForwardY,listenerForwardZ,listenerUpX,listenerUpY,listenerUpZ,distanceScale) { try { var audio = window.MG.audio; if (!audio || !audio.sources[sourceId]) return; var sourceInfo = audio.sources[sourceId]; if (audio.context.listener.positionX) { audio.context.listener.positionX.value = listenerPosX; audio.context.listener.positionY.value = listenerPosY; audio.context.listener.positionZ.value = listenerPosZ; audio.context.listener.forwardX.value = listenerForwardX; audio.context.listener.forwardY.value = listenerForwardY; audio.context.listener.forwardZ.value = listenerForwardZ; audio.context.listener.upX.value = listenerUpX; audio.context.listener.upY.value = listenerUpY; audio.context.listener.upZ.value = listenerUpZ; } else { audio.context.listener.setPosition(listenerPosX, listenerPosY, listenerPosZ); audio.context.listener.setOrientation( listenerForwardX, listenerForwardY, listenerForwardZ, listenerUpX, listenerUpY, listenerUpZ ); } if (!sourceInfo.is3D) { sourceInfo.gain.disconnect(); var panner = audio.context.createPanner(); panner.panningModel = 'HRTF'; panner.distanceModel = 'inverse'; panner.refDistance = 1; panner.maxDistance = 10000 * distanceScale; panner.rolloffFactor = 1; panner.coneInnerAngle = 360; panner.coneOuterAngle = 360; panner.coneOuterGain = 0; sourceInfo.gain.connect(panner); panner.connect(audio.masterGain); sourceInfo.panner = panner; sourceInfo.is3D = true; } if (sourceInfo.panner) { if (sourceInfo.panner.positionX) { sourceInfo.panner.positionX.value = posX; sourceInfo.panner.positionY.value = posY; sourceInfo.panner.positionZ.value = posZ; sourceInfo.panner.orientationX.value = forwardX; sourceInfo.panner.orientationY.value = forwardY; sourceInfo.panner.orientationZ.value = forwardZ; } else { sourceInfo.panner.setPosition(posX, posY, posZ); sourceInfo.panner.setOrientation(forwardX, forwardY, forwardZ); } } } catch (e) { console.error("Failed to set audio source 3D properties:", e); } }
function webAudioSetSourceFilter(sourceId,filterMode,frequency,q) { try { var audio = window.MG.audio; if (!audio || !audio.sources[sourceId]) return; var sourceInfo = audio.sources[sourceId]; if (sourceInfo.filter) { if (sourceInfo.is3D) { sourceInfo.gain.disconnect(); sourceInfo.gain.connect(sourceInfo.panner); } else if (sourceInfo.panner) { sourceInfo.gain.disconnect(); sourceInfo.gain.connect(sourceInfo.panner); } else { sourceInfo.gain.disconnect(); sourceInfo.gain.connect(audio.masterGain); } sourceInfo.filter = null; } if (filterMode >= 0 && frequency > 0) { var filter = audio.context.createBiquadFilter(); switch (filterMode) { case 0: filter.type = 'lowpass'; break; case 1: filter.type = 'bandpass'; break; case 2: filter.type = 'highpass'; break; default: filter.type = 'lowpass'; } filter.frequency.value = frequency; filter.Q.value = q; sourceInfo.gain.disconnect(); sourceInfo.gain.connect(filter); if (sourceInfo.is3D) { filter.connect(sourceInfo.panner); } else if (sourceInfo.panner) { filter.connect(sourceInfo.panner); } else { filter.connect(audio.masterGain); } sourceInfo.filter = filter; } } catch (e) { console.error("Failed to set audio source filter:", e); } }
function webAudioClearSourceFilter(sourceId) { try { var audio = window.MG.audio; if (!audio || !audio.sources[sourceId]) return; var sourceInfo = audio.sources[sourceId]; if (sourceInfo.filter) { sourceInfo.gain.disconnect(); if (sourceInfo.is3D) { sourceInfo.gain.connect(sourceInfo.panner); } else if (sourceInfo.panner) { sourceInfo.gain.connect(sourceInfo.panner); } else { sourceInfo.gain.connect(audio.masterGain); } sourceInfo.filter = null; } } catch (e) { console.error("Failed to clear audio source filter:", e); } }
function webAudioGetSourcePosition(sourceId) { try { var audio = window.MG.audio; if (!audio || !audio.sources[sourceId]) return 0; var sourceInfo = audio.sources[sourceId]; if (sourceInfo.paused) { return sourceInfo.pausePosition; } if (sourceInfo.source && sourceInfo.source.buffer) { var elapsedTime = audio.context.currentTime - sourceInfo.startTime; var duration = sourceInfo.source.buffer.duration; if (sourceInfo.looped) { return elapsedTime % duration; } return Math.min(elapsedTime, duration); } return 0; } catch (e) { console.error("Failed to get audio source position:", e); return 0; } }
function webAudioSetReverb(reflectionsDelay,reverbDelay,decayTime,density,roomSize) { try { var audio = window.MG.audio; if (!audio || !audio.context) return; var sampleRate = audio.context.sampleRate; var length = decayTime * sampleRate; var impulse = audio.context.createBuffer(2, length, sampleRate); for (var channel = 0; channel < 2; channel++) { var impulseData = impulse.getChannelData(channel); var initialDelay = Math.floor(reflectionsDelay * sampleRate / 1000); var reverbDelayInSamples = Math.floor(reverbDelay * sampleRate / 1000); for (var i = 0; i < length; i++) { if (i < initialDelay) { impulseData[i] = 0; } else if (i < initialDelay + reverbDelayInSamples) { impulseData[i] = (Math.random() * 2 - 1) * 0.1 * Math.exp(-(i - initialDelay) / (sampleRate * 0.02)); } else { var densityFactor = Math.min(1, density / 100); var roomFactor = roomSize / 100; var decay = Math.exp(-(i - initialDelay - reverbDelayInSamples) / (decayTime * sampleRate * roomFactor)); var noise = (Math.random() * 2 - 1) * densityFactor; impulseData[i] = noise * decay * 0.5; } } } audio.convolver.buffer = impulse; if (!audio.reverbConnected) { audio.masterGain.disconnect(); audio.masterGain.connect(audio.convolver); audio.convolver.connect(audio.context.destination); audio.reverbConnected = true; } } catch (e) { console.error("Failed to set reverb settings:", e); } }
function webAudioSetSourceReverbMix(sourceId,mix) { try { var audio = window.MG.audio; if (!audio || !audio.sources[sourceId]) return; var sourceInfo = audio.sources[sourceId]; if (mix > 0 && !sourceInfo.reverbSend) { var reverbSend = audio.context.createGain(); reverbSend.gain.value = mix; sourceInfo.gain.connect(reverbSend); reverbSend.connect(audio.convolver); sourceInfo.reverbSend = reverbSend; } else if (sourceInfo.reverbSend) { sourceInfo.reverbSend.gain.value = mix; if (mix <= 0) { sourceInfo.gain.disconnect(sourceInfo.reverbSend); sourceInfo.reverbSend = null; } } } catch (e) { console.error("Failed to set source reverb mix:", e); } }
function webAudioSetMasterVolume(volume) { try { var audio = window.MG.audio; if (!audio || !audio.masterGain) return; audio.masterGain.gain.value = volume; } catch (e) { console.error("Failed to set master volume:", e); } }
...
// end include: preamble.js
  ...
  /** @type {function(...*):?} */
  function _MGP_Platform_StartRunLoop(
  ) {
  abort('missing function: MGP_Platform_StartRunLoop');
  }
  _MGP_Platform_StartRunLoop.stub = true;
...
var wasmImports = {
  /** @export */
  MGP_Platform_StartRunLoop: _MGP_Platform_StartRunLoop,
  /** @export */
  ...
  strftime: _strftime,
  /** @export */
  webAudioClearSourceFilter: webAudioClearSourceFilter,
  /** @export */
  webAudioCreateBuffer: webAudioCreateBuffer,
  /** @export */
  webAudioCreateSource: webAudioCreateSource,
  /** @export */
  webAudioGetSourcePosition: webAudioGetSourcePosition,
  /** @export */
  webAudioGetSourceState: webAudioGetSourceState,
  /** @export */
  webAudioInit: webAudioInit,
  /** @export */
  webAudioPauseSource: webAudioPauseSource,
  /** @export */
  webAudioResumeSource: webAudioResumeSource,
  /** @export */
  webAudioSetReverb: webAudioSetReverb,
  /** @export */
  webAudioSetSource3D: webAudioSetSource3D,
  /** @export */
  webAudioSetSourceFilter: webAudioSetSourceFilter,
  /** @export */
  webAudioSetSourcePan: webAudioSetSourcePan,
  /** @export */
  webAudioSetSourcePitch: webAudioSetSourcePitch,
  /** @export */
  webAudioSetSourceReverbMix: webAudioSetSourceReverbMix,
  /** @export */
  webAudioSetSourceVolume: webAudioSetSourceVolume,
  /** @export */
  webAudioStopSource: webAudioStopSource
};
var wasmExports = createWasm();
var ___wasm_call_ctors = () => (___wasm_call_ctors = wasmExports['__wasm_call_ctors'])();
var _MGA_System_Create = Module['_MGA_System_Create'] = () => (_MGA_System_Create = Module['_MGA_System_Create'] = wasmExports['MGA_System_Create'])();
var _MGA_System_Destroy = Module['_MGA_System_Destroy'] = (a0) => (_MGA_System_Destroy = Module['_MGA_System_Destroy'] = wasmExports['MGA_System_Destroy'])(a0);
var _MGA_Voice_Stop = Module['_MGA_Voice_Stop'] = (a0, a1) => (_MGA_Voice_Stop = Module['_MGA_Voice_Stop'] = wasmExports['MGA_Voice_Stop'])(a0, a1);
var _MGA_Voice_Destroy = Module['_MGA_Voice_Destroy'] = (a0) => (_MGA_Voice_Destroy = Module['_MGA_Voice_Destroy'] = wasmExports['MGA_Voice_Destroy'])(a0);
var _MGA_System_GetMaxInstances = Module['_MGA_System_GetMaxInstances'] = () => (_MGA_System_GetMaxInstances = Module['_MGA_System_GetMaxInstances'] = wasmExports['MGA_System_GetMaxInstances'])();
var _MGA_System_SetReverbSettings = Module['_MGA_System_SetReverbSettings'] = (a0, a1) => (_MGA_System_SetReverbSettings = Module['_MGA_System_SetReverbSettings'] = wasmExports['MGA_System_SetReverbSettings'])(a0, a1);
var _MGA_Buffer_Create = Module['_MGA_Buffer_Create'] = (a0) => (_MGA_Buffer_Create = Module['_MGA_Buffer_Create'] = wasmExports['MGA_Buffer_Create'])(a0);
var _MGA_Buffer_Destroy = Module['_MGA_Buffer_Destroy'] = (a0) => (_MGA_Buffer_Destroy = Module['_MGA_Buffer_Destroy'] = wasmExports['MGA_Buffer_Destroy'])(a0);
var _MGA_Buffer_InitializeFormat = Module['_MGA_Buffer_InitializeFormat'] = (a0, a1, a2, a3, a4, a5) => (_MGA_Buffer_InitializeFormat = Module['_MGA_Buffer_InitializeFormat'] = wasmExports['MGA_Buffer_InitializeFormat'])(a0, a1, a2, a3, a4, a5);
var _MGA_Buffer_InitializePCM = Module['_MGA_Buffer_InitializePCM'] = (a0, a1, a2, a3, a4, a5, a6, a7, a8) => (_MGA_Buffer_InitializePCM = Module['_MGA_Buffer_InitializePCM'] = wasmExports['MGA_Buffer_InitializePCM'])(a0, a1, a2, a3, a4, a5, a6, a7, a8);
var _MGA_Buffer_InitializeXact = Module['_MGA_Buffer_InitializeXact'] = (a0, a1, a2, a3, a4, a5, a6, a7, a8) => (_MGA_Buffer_InitializeXact = Module['_MGA_Buffer_InitializeXact'] = wasmExports['MGA_Buffer_InitializeXact'])(a0, a1, a2, a3, a4, a5, a6, a7, a8);
var _MGA_Buffer_GetDuration = Module['_MGA_Buffer_GetDuration'] = (a0) => (_MGA_Buffer_GetDuration = Module['_MGA_Buffer_GetDuration'] = wasmExports['MGA_Buffer_GetDuration'])(a0);
var _MGA_Voice_Create = Module['_MGA_Voice_Create'] = (a0, a1, a2) => (_MGA_Voice_Create = Module['_MGA_Voice_Create'] = wasmExports['MGA_Voice_Create'])(a0, a1, a2);
var _MGA_Voice_GetBufferCount = Module['_MGA_Voice_GetBufferCount'] = (a0) => (_MGA_Voice_GetBufferCount = Module['_MGA_Voice_GetBufferCount'] = wasmExports['MGA_Voice_GetBufferCount'])(a0);
var _MGA_Voice_SetBuffer = Module['_MGA_Voice_SetBuffer'] = (a0, a1) => (_MGA_Voice_SetBuffer = Module['_MGA_Voice_SetBuffer'] = wasmExports['MGA_Voice_SetBuffer'])(a0, a1);
var _MGA_Voice_AppendBuffer = Module['_MGA_Voice_AppendBuffer'] = (a0, a1, a2) => (_MGA_Voice_AppendBuffer = Module['_MGA_Voice_AppendBuffer'] = wasmExports['MGA_Voice_AppendBuffer'])(a0, a1, a2);
var _MGA_Voice_Play = Module['_MGA_Voice_Play'] = (a0, a1) => (_MGA_Voice_Play = Module['_MGA_Voice_Play'] = wasmExports['MGA_Voice_Play'])(a0, a1);
var _MGA_Voice_Pause = Module['_MGA_Voice_Pause'] = (a0) => (_MGA_Voice_Pause = Module['_MGA_Voice_Pause'] = wasmExports['MGA_Voice_Pause'])(a0);
var _MGA_Voice_Resume = Module['_MGA_Voice_Resume'] = (a0) => (_MGA_Voice_Resume = Module['_MGA_Voice_Resume'] = wasmExports['MGA_Voice_Resume'])(a0);
var _MGA_Voice_GetState = Module['_MGA_Voice_GetState'] = (a0) => (_MGA_Voice_GetState = Module['_MGA_Voice_GetState'] = wasmExports['MGA_Voice_GetState'])(a0);
var _MGA_Voice_GetPosition = Module['_MGA_Voice_GetPosition'] = (a0) => (_MGA_Voice_GetPosition = Module['_MGA_Voice_GetPosition'] = wasmExports['MGA_Voice_GetPosition'])(a0);
var _MGA_Voice_SetPan = Module['_MGA_Voice_SetPan'] = (a0, a1) => (_MGA_Voice_SetPan = Module['_MGA_Voice_SetPan'] = wasmExports['MGA_Voice_SetPan'])(a0, a1);
var _MGA_Voice_SetPitch = Module['_MGA_Voice_SetPitch'] = (a0, a1) => (_MGA_Voice_SetPitch = Module['_MGA_Voice_SetPitch'] = wasmExports['MGA_Voice_SetPitch'])(a0, a1);
var _MGA_Voice_SetVolume = Module['_MGA_Voice_SetVolume'] = (a0, a1) => (_MGA_Voice_SetVolume = Module['_MGA_Voice_SetVolume'] = wasmExports['MGA_Voice_SetVolume'])(a0, a1);
var _MGA_Voice_SetReverbMix = Module['_MGA_Voice_SetReverbMix'] = (a0, a1) => (_MGA_Voice_SetReverbMix = Module['_MGA_Voice_SetReverbMix'] = wasmExports['MGA_Voice_SetReverbMix'])(a0, a1);
var _MGA_Voice_SetFilterMode = Module['_MGA_Voice_SetFilterMode'] = (a0, a1, a2, a3) => (_MGA_Voice_SetFilterMode = Module['_MGA_Voice_SetFilterMode'] = wasmExports['MGA_Voice_SetFilterMode'])(a0, a1, a2, a3);
var _MGA_Voice_ClearFilterMode = Module['_MGA_Voice_ClearFilterMode'] = (a0) => (_MGA_Voice_ClearFilterMode = Module['_MGA_Voice_ClearFilterMode'] = wasmExports['MGA_Voice_ClearFilterMode'])(a0);
var _MGA_Voice_Apply3D = Module['_MGA_Voice_Apply3D'] = (a0, a1, a2, a3) => (_MGA_Voice_Apply3D = Module['_MGA_Voice_Apply3D'] = wasmExports['MGA_Voice_Apply3D'])(a0, a1, a2, a3);
var _MGG_EffectResource_GetBytecode = Module['_MGG_EffectResource_GetBytecode'] = (a0, a1, a2) => (_MGG_EffectResource_GetBytecode = Module['_MGG_EffectResource_GetBytecode'] = wasmExports['MGG_EffectResource_GetBytecode'])(a0, a1, a2);
var _MGG_GraphicsSystem_Create = Module['_MGG_GraphicsSystem_Create'] = () => (_MGG_GraphicsSystem_Create = Module['_MGG_GraphicsSystem_Create'] = wasmExports['MGG_GraphicsSystem_Create'])();
var _MGG_GraphicsSystem_Destroy = Module['_MGG_GraphicsSystem_Destroy'] = (a0) => (_MGG_GraphicsSystem_Destroy = Module['_MGG_GraphicsSystem_Destroy'] = wasmExports['MGG_GraphicsSystem_Destroy'])(a0);
var _MGG_GraphicsAdapter_Get = Module['_MGG_GraphicsAdapter_Get'] = (a0, a1) => (_MGG_GraphicsAdapter_Get = Module['_MGG_GraphicsAdapter_Get'] = wasmExports['MGG_GraphicsAdapter_Get'])(a0, a1);
var _MGG_GraphicsAdapter_GetInfo = Module['_MGG_GraphicsAdapter_GetInfo'] = (a0, a1) => (_MGG_GraphicsAdapter_GetInfo = Module['_MGG_GraphicsAdapter_GetInfo'] = wasmExports['MGG_GraphicsAdapter_GetInfo'])(a0, a1);
var _MGG_GraphicsDevice_Create = Module['_MGG_GraphicsDevice_Create'] = (a0, a1) => (_MGG_GraphicsDevice_Create = Module['_MGG_GraphicsDevice_Create'] = wasmExports['MGG_GraphicsDevice_Create'])(a0, a1);
var _MGG_GraphicsDevice_Destroy = Module['_MGG_GraphicsDevice_Destroy'] = (a0) => (_MGG_GraphicsDevice_Destroy = Module['_MGG_GraphicsDevice_Destroy'] = wasmExports['MGG_GraphicsDevice_Destroy'])(a0);
var _MGG_GraphicsDevice_GetCaps = Module['_MGG_GraphicsDevice_GetCaps'] = (a0, a1) => (_MGG_GraphicsDevice_GetCaps = Module['_MGG_GraphicsDevice_GetCaps'] = wasmExports['MGG_GraphicsDevice_GetCaps'])(a0, a1);
var _MGG_GraphicsDevice_ResizeSwapchain = Module['_MGG_GraphicsDevice_ResizeSwapchain'] = (a0, a1, a2, a3, a4, a5) => (_MGG_GraphicsDevice_ResizeSwapchain = Module['_MGG_GraphicsDevice_ResizeSwapchain'] = wasmExports['MGG_GraphicsDevice_ResizeSwapchain'])(a0, a1, a2, a3, a4, a5);
var _MGG_GraphicsDevice_BeginFrame = Module['_MGG_GraphicsDevice_BeginFrame'] = (a0) => (_MGG_GraphicsDevice_BeginFrame = Module['_MGG_GraphicsDevice_BeginFrame'] = wasmExports['MGG_GraphicsDevice_BeginFrame'])(a0);
var _MGG_GraphicsDevice_Clear = Module['_MGG_GraphicsDevice_Clear'] = (a0, a1, a2, a3, a4) => (_MGG_GraphicsDevice_Clear = Module['_MGG_GraphicsDevice_Clear'] = wasmExports['MGG_GraphicsDevice_Clear'])(a0, a1, a2, a3, a4);
var _MGG_GraphicsDevice_Present = Module['_MGG_GraphicsDevice_Present'] = (a0, a1, a2) => (_MGG_GraphicsDevice_Present = Module['_MGG_GraphicsDevice_Present'] = wasmExports['MGG_GraphicsDevice_Present'])(a0, a1, a2);
var _MGG_GraphicsDevice_SetBlendState = Module['_MGG_GraphicsDevice_SetBlendState'] = (a0, a1, a2, a3, a4, a5) => (_MGG_GraphicsDevice_SetBlendState = Module['_MGG_GraphicsDevice_SetBlendState'] = wasmExports['MGG_GraphicsDevice_SetBlendState'])(a0, a1, a2, a3, a4, a5);
var _MGG_GraphicsDevice_SetDepthStencilState = Module['_MGG_GraphicsDevice_SetDepthStencilState'] = (a0, a1) => (_MGG_GraphicsDevice_SetDepthStencilState = Module['_MGG_GraphicsDevice_SetDepthStencilState'] = wasmExports['MGG_GraphicsDevice_SetDepthStencilState'])(a0, a1);
var _MGG_GraphicsDevice_SetRasterizerState = Module['_MGG_GraphicsDevice_SetRasterizerState'] = (a0, a1) => (_MGG_GraphicsDevice_SetRasterizerState = Module['_MGG_GraphicsDevice_SetRasterizerState'] = wasmExports['MGG_GraphicsDevice_SetRasterizerState'])(a0, a1);
var _MGG_GraphicsDevice_GetTitleSafeArea = Module['_MGG_GraphicsDevice_GetTitleSafeArea'] = (a0, a1, a2, a3) => (_MGG_GraphicsDevice_GetTitleSafeArea = Module['_MGG_GraphicsDevice_GetTitleSafeArea'] = wasmExports['MGG_GraphicsDevice_GetTitleSafeArea'])(a0, a1, a2, a3);
var _MGG_GraphicsDevice_SetViewport = Module['_MGG_GraphicsDevice_SetViewport'] = (a0, a1, a2, a3, a4, a5, a6) => (_MGG_GraphicsDevice_SetViewport = Module['_MGG_GraphicsDevice_SetViewport'] = wasmExports['MGG_GraphicsDevice_SetViewport'])(a0, a1, a2, a3, a4, a5, a6);
var _MGG_GraphicsDevice_SetScissorRectangle = Module['_MGG_GraphicsDevice_SetScissorRectangle'] = (a0, a1, a2, a3, a4) => (_MGG_GraphicsDevice_SetScissorRectangle = Module['_MGG_GraphicsDevice_SetScissorRectangle'] = wasmExports['MGG_GraphicsDevice_SetScissorRectangle'])(a0, a1, a2, a3, a4);
var _MGG_GraphicsDevice_SetRenderTargets = Module['_MGG_GraphicsDevice_SetRenderTargets'] = (a0, a1, a2, a3) => (_MGG_GraphicsDevice_SetRenderTargets = Module['_MGG_GraphicsDevice_SetRenderTargets'] = wasmExports['MGG_GraphicsDevice_SetRenderTargets'])(a0, a1, a2, a3);
var _MGG_GraphicsDevice_SetConstantBuffer = Module['_MGG_GraphicsDevice_SetConstantBuffer'] = (a0, a1, a2, a3) => (_MGG_GraphicsDevice_SetConstantBuffer = Module['_MGG_GraphicsDevice_SetConstantBuffer'] = wasmExports['MGG_GraphicsDevice_SetConstantBuffer'])(a0, a1, a2, a3);
var _MGG_GraphicsDevice_SetTexture = Module['_MGG_GraphicsDevice_SetTexture'] = (a0, a1, a2, a3) => (_MGG_GraphicsDevice_SetTexture = Module['_MGG_GraphicsDevice_SetTexture'] = wasmExports['MGG_GraphicsDevice_SetTexture'])(a0, a1, a2, a3);
var _MGG_GraphicsDevice_SetSamplerState = Module['_MGG_GraphicsDevice_SetSamplerState'] = (a0, a1, a2, a3) => (_MGG_GraphicsDevice_SetSamplerState = Module['_MGG_GraphicsDevice_SetSamplerState'] = wasmExports['MGG_GraphicsDevice_SetSamplerState'])(a0, a1, a2, a3);
var _MGG_GraphicsDevice_SetIndexBuffer = Module['_MGG_GraphicsDevice_SetIndexBuffer'] = (a0, a1, a2) => (_MGG_GraphicsDevice_SetIndexBuffer = Module['_MGG_GraphicsDevice_SetIndexBuffer'] = wasmExports['MGG_GraphicsDevice_SetIndexBuffer'])(a0, a1, a2);
var _MGG_GraphicsDevice_SetVertexBuffer = Module['_MGG_GraphicsDevice_SetVertexBuffer'] = (a0, a1, a2, a3) => (_MGG_GraphicsDevice_SetVertexBuffer = Module['_MGG_GraphicsDevice_SetVertexBuffer'] = wasmExports['MGG_GraphicsDevice_SetVertexBuffer'])(a0, a1, a2, a3);
var _MGG_GraphicsDevice_SetShader = Module['_MGG_GraphicsDevice_SetShader'] = (a0, a1, a2) => (_MGG_GraphicsDevice_SetShader = Module['_MGG_GraphicsDevice_SetShader'] = wasmExports['MGG_GraphicsDevice_SetShader'])(a0, a1, a2);
var _MGG_GraphicsDevice_SetInputLayout = Module['_MGG_GraphicsDevice_SetInputLayout'] = (a0, a1) => (_MGG_GraphicsDevice_SetInputLayout = Module['_MGG_GraphicsDevice_SetInputLayout'] = wasmExports['MGG_GraphicsDevice_SetInputLayout'])(a0, a1);
var _MGG_GraphicsDevice_Draw = Module['_MGG_GraphicsDevice_Draw'] = (a0, a1, a2, a3) => (_MGG_GraphicsDevice_Draw = Module['_MGG_GraphicsDevice_Draw'] = wasmExports['MGG_GraphicsDevice_Draw'])(a0, a1, a2, a3);
var _MGG_GraphicsDevice_DrawIndexed = Module['_MGG_GraphicsDevice_DrawIndexed'] = (a0, a1, a2, a3, a4) => (_MGG_GraphicsDevice_DrawIndexed = Module['_MGG_GraphicsDevice_DrawIndexed'] = wasmExports['MGG_GraphicsDevice_DrawIndexed'])(a0, a1, a2, a3, a4);
var _MGG_GraphicsDevice_DrawIndexedInstanced = Module['_MGG_GraphicsDevice_DrawIndexedInstanced'] = (a0, a1, a2, a3, a4, a5) => (_MGG_GraphicsDevice_DrawIndexedInstanced = Module['_MGG_GraphicsDevice_DrawIndexedInstanced'] = wasmExports['MGG_GraphicsDevice_DrawIndexedInstanced'])(a0, a1, a2, a3, a4, a5);
var _MGG_GraphicsDevice_ResolveRenderTargets = Module['_MGG_GraphicsDevice_ResolveRenderTargets'] = (a0) => (_MGG_GraphicsDevice_ResolveRenderTargets = Module['_MGG_GraphicsDevice_ResolveRenderTargets'] = wasmExports['MGG_GraphicsDevice_ResolveRenderTargets'])(a0);
var _MGG_GraphicsDevice_GetBackBufferData = Module['_MGG_GraphicsDevice_GetBackBufferData'] = (a0, a1, a2, a3, a4, a5, a6, a7) => (_MGG_GraphicsDevice_GetBackBufferData = Module['_MGG_GraphicsDevice_GetBackBufferData'] = wasmExports['MGG_GraphicsDevice_GetBackBufferData'])(a0, a1, a2, a3, a4, a5, a6, a7);
var _MGG_BlendState_Create = Module['_MGG_BlendState_Create'] = (a0, a1) => (_MGG_BlendState_Create = Module['_MGG_BlendState_Create'] = wasmExports['MGG_BlendState_Create'])(a0, a1);
var _MGG_BlendState_Destroy = Module['_MGG_BlendState_Destroy'] = (a0, a1) => (_MGG_BlendState_Destroy = Module['_MGG_BlendState_Destroy'] = wasmExports['MGG_BlendState_Destroy'])(a0, a1);
var _MGG_DepthStencilState_Create = Module['_MGG_DepthStencilState_Create'] = (a0, a1) => (_MGG_DepthStencilState_Create = Module['_MGG_DepthStencilState_Create'] = wasmExports['MGG_DepthStencilState_Create'])(a0, a1);
var _MGG_DepthStencilState_Destroy = Module['_MGG_DepthStencilState_Destroy'] = (a0, a1) => (_MGG_DepthStencilState_Destroy = Module['_MGG_DepthStencilState_Destroy'] = wasmExports['MGG_DepthStencilState_Destroy'])(a0, a1);
var _MGG_RasterizerState_Create = Module['_MGG_RasterizerState_Create'] = (a0, a1) => (_MGG_RasterizerState_Create = Module['_MGG_RasterizerState_Create'] = wasmExports['MGG_RasterizerState_Create'])(a0, a1);
var _MGG_RasterizerState_Destroy = Module['_MGG_RasterizerState_Destroy'] = (a0, a1) => (_MGG_RasterizerState_Destroy = Module['_MGG_RasterizerState_Destroy'] = wasmExports['MGG_RasterizerState_Destroy'])(a0, a1);
var _MGG_SamplerState_Create = Module['_MGG_SamplerState_Create'] = (a0, a1) => (_MGG_SamplerState_Create = Module['_MGG_SamplerState_Create'] = wasmExports['MGG_SamplerState_Create'])(a0, a1);
var _MGG_SamplerState_Destroy = Module['_MGG_SamplerState_Destroy'] = (a0, a1) => (_MGG_SamplerState_Destroy = Module['_MGG_SamplerState_Destroy'] = wasmExports['MGG_SamplerState_Destroy'])(a0, a1);
var _MGG_Buffer_Create = Module['_MGG_Buffer_Create'] = (a0, a1, a2) => (_MGG_Buffer_Create = Module['_MGG_Buffer_Create'] = wasmExports['MGG_Buffer_Create'])(a0, a1, a2);
var _MGG_Buffer_Destroy = Module['_MGG_Buffer_Destroy'] = (a0, a1) => (_MGG_Buffer_Destroy = Module['_MGG_Buffer_Destroy'] = wasmExports['MGG_Buffer_Destroy'])(a0, a1);
var _MGG_Buffer_SetData = Module['_MGG_Buffer_SetData'] = (a0, a1, a2, a3, a4, a5, a6, a7) => (_MGG_Buffer_SetData = Module['_MGG_Buffer_SetData'] = wasmExports['MGG_Buffer_SetData'])(a0, a1, a2, a3, a4, a5, a6, a7);
var _MGG_Buffer_GetData = Module['_MGG_Buffer_GetData'] = (a0, a1, a2, a3, a4, a5, a6) => (_MGG_Buffer_GetData = Module['_MGG_Buffer_GetData'] = wasmExports['MGG_Buffer_GetData'])(a0, a1, a2, a3, a4, a5, a6);
var _MGG_Texture_Create = Module['_MGG_Texture_Create'] = (a0, a1, a2, a3, a4, a5, a6, a7) => (_MGG_Texture_Create = Module['_MGG_Texture_Create'] = wasmExports['MGG_Texture_Create'])(a0, a1, a2, a3, a4, a5, a6, a7);
var _MGG_RenderTarget_Create = Module['_MGG_RenderTarget_Create'] = (a0, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10) => (_MGG_RenderTarget_Create = Module['_MGG_RenderTarget_Create'] = wasmExports['MGG_RenderTarget_Create'])(a0, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10);
var _MGG_Texture_Destroy = Module['_MGG_Texture_Destroy'] = (a0, a1) => (_MGG_Texture_Destroy = Module['_MGG_Texture_Destroy'] = wasmExports['MGG_Texture_Destroy'])(a0, a1);
var _MGG_Texture_SetData = Module['_MGG_Texture_SetData'] = (a0, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11) => (_MGG_Texture_SetData = Module['_MGG_Texture_SetData'] = wasmExports['MGG_Texture_SetData'])(a0, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11);
var _MGG_Texture_GetData = Module['_MGG_Texture_GetData'] = (a0, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11) => (_MGG_Texture_GetData = Module['_MGG_Texture_GetData'] = wasmExports['MGG_Texture_GetData'])(a0, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11);
var _MGG_InputLayout_Create = Module['_MGG_InputLayout_Create'] = (a0, a1, a2, a3, a4, a5) => (_MGG_InputLayout_Create = Module['_MGG_InputLayout_Create'] = wasmExports['MGG_InputLayout_Create'])(a0, a1, a2, a3, a4, a5);
var _MGG_InputLayout_Destroy = Module['_MGG_InputLayout_Destroy'] = (a0, a1) => (_MGG_InputLayout_Destroy = Module['_MGG_InputLayout_Destroy'] = wasmExports['MGG_InputLayout_Destroy'])(a0, a1);
var _MGG_Shader_Create = Module['_MGG_Shader_Create'] = (a0, a1, a2, a3) => (_MGG_Shader_Create = Module['_MGG_Shader_Create'] = wasmExports['MGG_Shader_Create'])(a0, a1, a2, a3);
var _MGG_Shader_Destroy = Module['_MGG_Shader_Destroy'] = (a0, a1) => (_MGG_Shader_Destroy = Module['_MGG_Shader_Destroy'] = wasmExports['MGG_Shader_Destroy'])(a0, a1);
var _MGG_OcclusionQuery_Create = Module['_MGG_OcclusionQuery_Create'] = (a0) => (_MGG_OcclusionQuery_Create = Module['_MGG_OcclusionQuery_Create'] = wasmExports['MGG_OcclusionQuery_Create'])(a0);
var _MGG_OcclusionQuery_Destroy = Module['_MGG_OcclusionQuery_Destroy'] = (a0, a1) => (_MGG_OcclusionQuery_Destroy = Module['_MGG_OcclusionQuery_Destroy'] = wasmExports['MGG_OcclusionQuery_Destroy'])(a0, a1);
var _MGG_OcclusionQuery_Begin = Module['_MGG_OcclusionQuery_Begin'] = (a0, a1) => (_MGG_OcclusionQuery_Begin = Module['_MGG_OcclusionQuery_Begin'] = wasmExports['MGG_OcclusionQuery_Begin'])(a0, a1);
var _MGG_OcclusionQuery_End = Module['_MGG_OcclusionQuery_End'] = (a0, a1) => (_MGG_OcclusionQuery_End = Module['_MGG_OcclusionQuery_End'] = wasmExports['MGG_OcclusionQuery_End'])(a0, a1);
var _MGG_OcclusionQuery_GetResult = Module['_MGG_OcclusionQuery_GetResult'] = (a0, a1, a2) => (_MGG_OcclusionQuery_GetResult = Module['_MGG_OcclusionQuery_GetResult'] = wasmExports['MGG_OcclusionQuery_GetResult'])(a0, a1, a2);
var _MGP_Platform_Create = Module['_MGP_Platform_Create'] = (a0) => (_MGP_Platform_Create = Module['_MGP_Platform_Create'] = wasmExports['MGP_Platform_Create'])(a0);
var _MGP_Platform_Destroy = Module['_MGP_Platform_Destroy'] = (a0) => (_MGP_Platform_Destroy = Module['_MGP_Platform_Destroy'] = wasmExports['MGP_Platform_Destroy'])(a0);
var _MGP_Window_Destroy = Module['_MGP_Window_Destroy'] = (a0) => (_MGP_Window_Destroy = Module['_MGP_Window_Destroy'] = wasmExports['MGP_Window_Destroy'])(a0);
var _MGP_Platform_MakePath = Module['_MGP_Platform_MakePath'] = (a0, a1) => (_MGP_Platform_MakePath = Module['_MGP_Platform_MakePath'] = wasmExports['MGP_Platform_MakePath'])(a0, a1);
var _MGP_Platform_Free = Module['_MGP_Platform_Free'] = (a0) => (_MGP_Platform_Free = Module['_MGP_Platform_Free'] = wasmExports['MGP_Platform_Free'])(a0);
var _MGP_Platform_BeforeInitialize = Module['_MGP_Platform_BeforeInitialize'] = (a0) => (_MGP_Platform_BeforeInitialize = Module['_MGP_Platform_BeforeInitialize'] = wasmExports['MGP_Platform_BeforeInitialize'])(a0);
var _MGP_Platform_GetPlatform = Module['_MGP_Platform_GetPlatform'] = () => (_MGP_Platform_GetPlatform = Module['_MGP_Platform_GetPlatform'] = wasmExports['MGP_Platform_GetPlatform'])();
var _MGP_Platform_GetGraphicsBackend = Module['_MGP_Platform_GetGraphicsBackend'] = () => (_MGP_Platform_GetGraphicsBackend = Module['_MGP_Platform_GetGraphicsBackend'] = wasmExports['MGP_Platform_GetGraphicsBackend'])();
var _MGP_Platform_PollEvent = Module['_MGP_Platform_PollEvent'] = (a0, a1) => (_MGP_Platform_PollEvent = Module['_MGP_Platform_PollEvent'] = wasmExports['MGP_Platform_PollEvent'])(a0, a1);
var _MGP_Platform_BeforeRun = Module['_MGP_Platform_BeforeRun'] = (a0) => (_MGP_Platform_BeforeRun = Module['_MGP_Platform_BeforeRun'] = wasmExports['MGP_Platform_BeforeRun'])(a0);
var _MGP_Platform_BeforeUpdate = Module['_MGP_Platform_BeforeUpdate'] = (a0) => (_MGP_Platform_BeforeUpdate = Module['_MGP_Platform_BeforeUpdate'] = wasmExports['MGP_Platform_BeforeUpdate'])(a0);
var _MGP_Platform_BeforeDraw = Module['_MGP_Platform_BeforeDraw'] = (a0) => (_MGP_Platform_BeforeDraw = Module['_MGP_Platform_BeforeDraw'] = wasmExports['MGP_Platform_BeforeDraw'])(a0);
var _MGP_Window_Create = Module['_MGP_Window_Create'] = (a0, a1, a2, a3) => (_MGP_Window_Create = Module['_MGP_Window_Create'] = wasmExports['MGP_Window_Create'])(a0, a1, a2, a3);
var _MGP_Window_SetIconBitmap = Module['_MGP_Window_SetIconBitmap'] = (a0, a1, a2) => (_MGP_Window_SetIconBitmap = Module['_MGP_Window_SetIconBitmap'] = wasmExports['MGP_Window_SetIconBitmap'])(a0, a1, a2);
var _MGP_Window_GetNativeHandle = Module['_MGP_Window_GetNativeHandle'] = (a0) => (_MGP_Window_GetNativeHandle = Module['_MGP_Window_GetNativeHandle'] = wasmExports['MGP_Window_GetNativeHandle'])(a0);
var _MGP_Window_GetAllowUserResizing = Module['_MGP_Window_GetAllowUserResizing'] = (a0) => (_MGP_Window_GetAllowUserResizing = Module['_MGP_Window_GetAllowUserResizing'] = wasmExports['MGP_Window_GetAllowUserResizing'])(a0);
var _MGP_Window_SetAllowUserResizing = Module['_MGP_Window_SetAllowUserResizing'] = (a0, a1) => (_MGP_Window_SetAllowUserResizing = Module['_MGP_Window_SetAllowUserResizing'] = wasmExports['MGP_Window_SetAllowUserResizing'])(a0, a1);
var _MGP_Window_GetIsBorderless = Module['_MGP_Window_GetIsBorderless'] = (a0) => (_MGP_Window_GetIsBorderless = Module['_MGP_Window_GetIsBorderless'] = wasmExports['MGP_Window_GetIsBorderless'])(a0);
var _MGP_Window_SetIsBorderless = Module['_MGP_Window_SetIsBorderless'] = (a0, a1) => (_MGP_Window_SetIsBorderless = Module['_MGP_Window_SetIsBorderless'] = wasmExports['MGP_Window_SetIsBorderless'])(a0, a1);
var _MGP_Window_SetTitle = Module['_MGP_Window_SetTitle'] = (a0, a1) => (_MGP_Window_SetTitle = Module['_MGP_Window_SetTitle'] = wasmExports['MGP_Window_SetTitle'])(a0, a1);
var _MGP_Window_Show = Module['_MGP_Window_Show'] = (a0, a1) => (_MGP_Window_Show = Module['_MGP_Window_Show'] = wasmExports['MGP_Window_Show'])(a0, a1);
var _MGP_Window_GetPosition = Module['_MGP_Window_GetPosition'] = (a0, a1, a2) => (_MGP_Window_GetPosition = Module['_MGP_Window_GetPosition'] = wasmExports['MGP_Window_GetPosition'])(a0, a1, a2);
var _MGP_Window_SetPosition = Module['_MGP_Window_SetPosition'] = (a0, a1, a2) => (_MGP_Window_SetPosition = Module['_MGP_Window_SetPosition'] = wasmExports['MGP_Window_SetPosition'])(a0, a1, a2);
var _MGP_Window_SetClientSize = Module['_MGP_Window_SetClientSize'] = (a0, a1, a2) => (_MGP_Window_SetClientSize = Module['_MGP_Window_SetClientSize'] = wasmExports['MGP_Window_SetClientSize'])(a0, a1, a2);
var _MGP_Window_SetCursor = Module['_MGP_Window_SetCursor'] = (a0, a1) => (_MGP_Window_SetCursor = Module['_MGP_Window_SetCursor'] = wasmExports['MGP_Window_SetCursor'])(a0, a1);
var _MGP_Window_EnterFullScreen = Module['_MGP_Window_EnterFullScreen'] = (a0, a1) => (_MGP_Window_EnterFullScreen = Module['_MGP_Window_EnterFullScreen'] = wasmExports['MGP_Window_EnterFullScreen'])(a0, a1);
var _MGP_Window_ExitFullScreen = Module['_MGP_Window_ExitFullScreen'] = (a0) => (_MGP_Window_ExitFullScreen = Module['_MGP_Window_ExitFullScreen'] = wasmExports['MGP_Window_ExitFullScreen'])(a0);
var _MGP_Window_ShowMessageBox = Module['_MGP_Window_ShowMessageBox'] = (a0, a1, a2, a3, a4) => (_MGP_Window_ShowMessageBox = Module['_MGP_Window_ShowMessageBox'] = wasmExports['MGP_Window_ShowMessageBox'])(a0, a1, a2, a3, a4);
var _MGP_Mouse_SetVisible = Module['_MGP_Mouse_SetVisible'] = (a0, a1) => (_MGP_Mouse_SetVisible = Module['_MGP_Mouse_SetVisible'] = wasmExports['MGP_Mouse_SetVisible'])(a0, a1);
var _MGP_Mouse_WarpPosition = Module['_MGP_Mouse_WarpPosition'] = (a0, a1, a2) => (_MGP_Mouse_WarpPosition = Module['_MGP_Mouse_WarpPosition'] = wasmExports['MGP_Mouse_WarpPosition'])(a0, a1, a2);
var _MGP_Cursor_Create = Module['_MGP_Cursor_Create'] = (a0) => (_MGP_Cursor_Create = Module['_MGP_Cursor_Create'] = wasmExports['MGP_Cursor_Create'])(a0);
var _MGP_Cursor_CreateCustom = Module['_MGP_Cursor_CreateCustom'] = (a0, a1, a2, a3, a4) => (_MGP_Cursor_CreateCustom = Module['_MGP_Cursor_CreateCustom'] = wasmExports['MGP_Cursor_CreateCustom'])(a0, a1, a2, a3, a4);
var _MGP_Cursor_Destroy = Module['_MGP_Cursor_Destroy'] = (a0) => (_MGP_Cursor_Destroy = Module['_MGP_Cursor_Destroy'] = wasmExports['MGP_Cursor_Destroy'])(a0);
var _MGP_GamePad_GetMaxSupported = Module['_MGP_GamePad_GetMaxSupported'] = () => (_MGP_GamePad_GetMaxSupported = Module['_MGP_GamePad_GetMaxSupported'] = wasmExports['MGP_GamePad_GetMaxSupported'])();
var _MGP_GamePad_GetCaps = Module['_MGP_GamePad_GetCaps'] = (a0, a1, a2) => (_MGP_GamePad_GetCaps = Module['_MGP_GamePad_GetCaps'] = wasmExports['MGP_GamePad_GetCaps'])(a0, a1, a2);
var _MGP_GamePad_SetVibration = Module['_MGP_GamePad_SetVibration'] = (a0, a1, a2, a3, a4, a5) => (_MGP_GamePad_SetVibration = Module['_MGP_GamePad_SetVibration'] = wasmExports['MGP_GamePad_SetVibration'])(a0, a1, a2, a3, a4, a5);
...
var ___start_em_js = Module['___start_em_js'] = 623356;
var ___stop_em_js = Module['___stop_em_js'] = 637598;
